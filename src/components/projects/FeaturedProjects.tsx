    ...
    <section id="projects" className={styles.section}>
      <div className={styles.inner}>
        ...
        <div className={styles.mosaic}>
          {lead && (
            <ProjectTile project={lead} layout="lead" onOpen={onOpen} priority />
          )}

          <div className={styles.cluster}>
            {tall && <ProjectTile project={tall} layout="tall" onOpen={onOpen} />}
            <div className={styles.stack}>
              {portrait && (
                <ProjectTile project={portrait} layout="portrait" onOpen={onOpen} />
              )}
              {wide && <ProjectTile project={wide} layout="wide" onOpen={onOpen} />}
            </div>
          </div>
        </div>
      </div>
